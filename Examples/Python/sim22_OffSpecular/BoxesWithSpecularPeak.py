...
def get_sample():
    ...
    # Define form factors
    formFactor_1 = ba.FormFactorBox(5.0*nm, 5.0*nm, 10.0*nm)

    # Define particles
    particle_1 = ba.Particle(material_2, formFactor_1)

    # Define 2D lattices
    lattice2D_1 = ba.BasicLattice2D(8.0*nm, 8.0*nm, 90.0*deg, 0.0*deg)
    ...
    layout_1.setTotalParticleSurfaceDensity(0.015625)
