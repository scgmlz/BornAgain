...
def get_sample():
    ...
    # Define 2D lattices
    lattice2D_1 = ba.BasicLattice2D(25.0*nm, 25.0*nm, 90.0*deg, 30.0*deg)

    # Define interference functions
    interference_1 = ba.InterferenceFunction2DLattice(lattice2D_1)
    interference_1_pdf = ba.FTDecayFunction2DCauchy(47.7464829276*nm,
                                                    15.9154943092*nm, 30.0*deg)
