...
TEST_F(MaterialTest, TypeIdsTest)
{
    ...
    EXPECT_TRUE(material.typeID() == BaseMaterialImpl::g_typeID<WavelengthIndependentMaterial>());
    EXPECT_TRUE(material2.typeID() == BaseMaterialImpl::g_typeID<RefractiveCoefMaterial>());
