...
VariableBinAxis::VariableBinAxis(const std::string& name, int nbins) : IAxis(name), m_nbins(nbins)
{
}
...
double VariableBinAxis::operator[](size_t index) const { return getBin(index).getMidPoint(); }
...
double VariableBinAxis::getMin() const { return m_bin_boundaries.front(); }


double VariableBinAxis::getMax() const { return m_bin_boundaries.back(); }

double VariableBinAxis::getBinCenter(size_t index) const { return getBin(index).getMidPoint(); }
