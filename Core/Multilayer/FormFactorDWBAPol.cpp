...
{
    complex_t kiz[2] = { mp_in_coeffs->getKz()(0), mp_in_coeffs->getKz()(1) };
    complex_t kfz[2] = { mp_out_coeffs->getKz()(0), mp_out_coeffs->getKz()(1) };
    ...
    ff_BA = mp_form_factor->evaluatePol(wavevectors.newZZ(-kiz[0],+kfz[0]));
    ...
    ff_BA = mp_form_factor->evaluatePol(wavevectors.newZZ(-kiz[0],+kfz[1]));
    ...
    ff_BA = mp_form_factor->evaluatePol(wavevectors.newZZ(-kiz[1],+kfz[0]));
    ...
    ff_BA = mp_form_factor->evaluatePol(wavevectors.newZZ(-kiz[1],+kfz[1]));
