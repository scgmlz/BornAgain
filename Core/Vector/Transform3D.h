...
public:
    ...
    //! Return transformed vector _v_.
    BasicVector3D<complex_t> transformed(const BasicVector3D<complex_t>& v) const;

    //! Return transformed vector _v_.
    BasicVector3D<double> transformedInverse(const BasicVector3D<double>& v) const;

    //! Return transformed vector _v_.
    BasicVector3D<complex_t> transformedInverse(const BasicVector3D<complex_t>& v) const;
