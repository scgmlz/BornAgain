...
IHistogram::IHistogram(const IHistogram& other) { m_data.copyFrom(other.m_data); }

IHistogram::IHistogram(const IAxis& axis_x) { m_data.addAxis(axis_x); }
...
size_t IHistogram::getTotalNumberOfBins() const { return m_data.getAllocatedSize(); }
...
double IHistogram::getXmin() const { return getXaxis().getMin(); }

double IHistogram::getXmax() const { return getXaxis().getMax(); }

size_t IHistogram::getNbinsX() const { return getXaxis().size(); }

double IHistogram::getYmin() const { return getYaxis().getMin(); }

double IHistogram::getYmax() const { return getYaxis().getMax(); }

size_t IHistogram::getNbinsY() const { return getYaxis().size(); }
...
int IHistogram::getXaxisIndex(size_t i) const { return m_data.getAxisBinIndex(i, 0); }

int IHistogram::getYaxisIndex(size_t i) const { return m_data.getAxisBinIndex(i, 1); }
...
double IHistogram::getBinContent(size_t i) const { return m_data[i].getContent(); }
...
void IHistogram::setBinContent(size_t i, double value) { m_data[i].setContent(value); }

void IHistogram::addBinContent(size_t i, double value) { m_data[i].add(value); }

double IHistogram::getBinError(size_t i) const { return m_data[i].getRMS(); }
...
double IHistogram::getBinAverage(size_t i) const { return m_data[i].getAverage(); }
...
int IHistogram::getBinNumberOfEntries(size_t i) const { return m_data[i].getNumberOfEntries(); }
...
void IHistogram::reset() { m_data.setAllTo(CumulativeValue()); }
