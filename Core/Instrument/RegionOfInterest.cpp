...
RegionOfInterest::RegionOfInterest(
    const IDetector2D& detector, double xlow, double ylow, double xup, double yup)
...
RegionOfInterest::RegionOfInterest(
    const OutputData<double>& data, double xlow, double ylow, double xup, double yup)
    : RegionOfInterest(xlow, ylow, xup, yup)
{
    if (data.getRank() != 2)
...
RegionOfInterest* RegionOfInterest::clone() const { return new RegionOfInterest(*this); }
...
double RegionOfInterest::getXlow() const { return m_rectangle->getXlow(); }

double RegionOfInterest::getYlow() const { return m_rectangle->getYlow(); }

double RegionOfInterest::getXup() const { return m_rectangle->getXup(); }

double RegionOfInterest::getYup() const { return m_rectangle->getYup(); }
...
size_t RegionOfInterest::roiSize() const { return m_roi_dims[0] * m_roi_dims[1]; }

size_t RegionOfInterest::detectorSize() const { return m_detector_dims[0] * m_detector_dims[1]; }
