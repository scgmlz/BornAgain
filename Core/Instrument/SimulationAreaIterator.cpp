...
int SimulationAreaIterator::roiIndex() const { return m_area->roiIndex(m_index); }

int SimulationAreaIterator::detectorIndex() const { return m_area->detectorIndex(m_index); }
