...
Eigen::Matrix2cd FormFactorDecoratorMaterial::evaluatePol(const WavevectorInfo& wavevectors) const
{
    ...
    Eigen::Matrix2cd V_eff = time_reverse_conj
                             * (  m_material.polarizedSubstrSLD(wavevectors)
                                - m_ambient_material.polarizedSubstrSLD(wavevectors) );
...
{
    return m_material.scalarSubstrSLD(wavevectors) - m_ambient_material.scalarSubstrSLD(wavevectors);
}
